...
const formSchema = z.object({
    ...
    // every menu item has a name and price -> object
    ...
    // path is where we want to displa the image
...
const ManageRestaurantForm = ({ onSave, isLoading, restaurant }: Props) => {
    ...
    const onSubmit = (formDataJson: RestaurantFormData) => {
        ...
        // Convert values to string, because http requests only deal with strings
